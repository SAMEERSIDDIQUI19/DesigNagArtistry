...
export default function HomeClient({ initialContent }: { initialContent: HomeContent | null }) {
  const [content, setContent] = useState<HomeContent | null>(initialContent ?? null);
                    ...
                    <div className="col-md-12">
                      <div className="banner-item banner-item-responsive position-relative overflow-hidden">
                        ...
                        <div className="billboard-btn-wrap">
                          <Link href={slide.buttonLink} className="btn btn-medium btn-arrow position-relative" style={slide.buttonOutlineColor ? { borderColor: slide.buttonOutlineColor, color: slide.buttonOutlineColor } : {}}>
