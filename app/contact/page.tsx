...
export const metadata: Metadata = {
  ...
  description: "Get in touch with Designagartistry. Contact us via WhatsApp, email, or our contact form for inquiries about luxury fashion, orders, and customer support.",
  keywords: [
    "contact Designagartistry",
    "customer support Pakistan",
    "luxury fashion contact",
    "WhatsApp support",
    "designer brand contact",
  ],
  openGraph: {
    type: "website",
