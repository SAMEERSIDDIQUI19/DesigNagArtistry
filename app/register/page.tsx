...
export const metadata: Metadata = {
  title: "Customer Registration | Designagartistry",
  robots: {
    index: false,
    follow: true,
  },
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex items-center justify-center">
      <div className="bg-white rounded-lg shadow-md p-8 max-w-md w-full">
        <h1 className="text-2xl font-bold text-gray-900 mb-6 text-center">Customer Registration</h1>
        ...
        <p className="text-center mt-2">
          <Link href="/checkout" className="text-gray-600 hover:text-gray-800 text-sm">
            Continue as Guest
          </Link>
        </p>
      </div>
